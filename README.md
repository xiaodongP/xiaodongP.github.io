...
站点右下角有一个前端访问计数器，用来显示本站访客数、本站访问量和当前文章访问量。它基于不蒜子统计服务，适合 GitHub Pages 这类静态网站。

站点也预留了 Chirpy 内置的 Umami Analytics 配置，用来统计更详细的访问来源地区。Umami 可以在后台查看页面浏览量、访客数、来源、设备和国家/地区等信息。
